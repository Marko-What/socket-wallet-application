...
exports.walletErrorHandler = (result, playerId, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (result == "done") {
...
exports.transactionErrorHandler = (result, playerId, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (result == "done") {
        return res.status(200).json("message: transaction with playerid: " + playerId + " done");
    }
    ;
    if (result == "error") {
        return res.status(400).json("message: something went wrong");
